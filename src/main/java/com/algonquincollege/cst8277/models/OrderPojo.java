...
@NamedQuery(name=ORDERS_BY_CUSID_QUERY_NAME, query = "select o FROM Order o join o.owningCustomer oc where oc.id = ?1")
public class OrderPojo extends PojoBase implements Serializable {
    private static final long serialVersionUID = 1L;
    
    public static final String ORDERS_BY_CUSID_QUERY_NAME = "allOrdersByCustId";
